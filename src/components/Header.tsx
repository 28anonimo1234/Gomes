        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="flex items-center space-x-2 text-gray-700 hover:text-green-600 transition-colors relative">
          ...
          >
            <div className="px-4 py-4 space-y-4">
              ...
              <div className="flex items-center justify-around py-4 border-b">
                ...
                <button className="flex flex-col items-center space-y-1 text-gray-700 relative">
            ...
            <div className="max-w-7xl mx-auto px-4 py-6">
              ...
              <div className="mt-6 pt-4 border-t">
                <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                  <a href="#" className="hover:text-blue-600 transition-colors">Ver todas as categorias</a>
                  <span>•</span>
                  <a href="#" className="hover:text-blue-600 transition-colors">Marcas populares</a>
                  <span>•</span>
                  <a href="#" className="hover:text-blue-600 transition-colors">Guia de compras</a>
                </div>
              </div>
            </div>
          </motion.div>
